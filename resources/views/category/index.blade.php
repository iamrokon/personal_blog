<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-wrap justify-between">
            ...
            @endif
            <a href="{{ route('category.create') }}" class="inline-block px-4 py-2 leading-none text-white bg-blue-500 hover:bg-blue-600 rounded">Add Category</a>
        </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="mt-6">
                    ...
                    <div class="r-pagi">{{ $categories->links() }}</div>
                </div>
            </div>
        </div>
    </div>
